...
% load references
\addbibresource{crete_idea.bib} % The filename of the bibliography
% Adjust bibliography font size
\renewcommand*{\bibfont}{\small} % Use \footnotesize, \small, or other sizes
% title
%\title{Island-Wide Soil Metagenomics: A Gateway to Enhancing Plant Tolerance in Crete}      % Define the title
...
% Header
\fancyhead[L]{S. Paragkamian} % Left part of the header

%\renewcommand{\headrulewidth}{0pt} % Remove header line
\fancyhead[R]{% Add the logo
    \includegraphics[width=3cm]{logo_ess.png} % Adjust the size and path of your logo
}
\fancyhead[C]{European Soil Science} % Center part of the header
\fancyhead[L]{Paragkamian S.} % Right part of the header

% Footer
%\fancyfoot[L]{Left Footer Text} % Left part of the footer
%\fancyfoot[C]{Page \thepage} % Center part of the footer (e.g., page number)
\fancyfoot[R]{Page \thepage} % Right part of the footer

% Optional: Remove header/footer from the first page
%\thispagestyle{plain}

\begin{document}

\begin{center}
    {\Huge Island-Wide Soil integration: the case of Crete}\\[2em]
    {\large Savvas Paragkamian, Neil Davies, Panagiotis F. Sarris, Evangelos Pafilis, Georgios Kotoulas}\\[1em]
    {\large \today}
\end{center}
